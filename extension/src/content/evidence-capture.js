...
function showLoadingToast(message) {
  ...
  spinner.style.cssText =
    "width: 16px; height: 16px; border: 2px solid white; border-top-color: transparent; border-radius: 50%; animation: x-spin 1s linear infinite;";
